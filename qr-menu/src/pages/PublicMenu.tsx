          ...
          <div className="menu-hero mb-3 rounded-2xl border border-border/60 bg-bg/70 p-2.5">
            <div className="flex items-center justify-between gap-2.5">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h1 className="font-heading text-[1.75rem] font-semibold leading-none tracking-tight md:text-4xl">Plan B</h1>
                  <p className="mt-1 text-xs font-medium uppercase tracking-[0.17em] text-muted/70">Plan B Menu</p>
                </div>
              </div>
              <LanguageToggle />
            </div>
