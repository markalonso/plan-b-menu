  ...
  return (
    ...
    >
      ...
      <section
        ...
        aria-modal="true"
        className={cn(
          'absolute inset-x-0 bottom-0 rounded-t-3xl border border-border bg-surface p-5 shadow-elevate transition-transform duration-[220ms] ease-calm',
      ...
      >
        ...
        {title ? <h3 className="mb-2 text-xl font-bold text-text">{title}</h3> : null}
        <div className="no-scrollbar overflow-y-auto" style={{ maxHeight: 'calc(85vh - 5rem)' }}>
          {children}
        </div>
      </section>
    </div>
